...
//If core is not defined, then we are running in Arduino or PIO
  ...
  #define CONFIG_ASYNC_TCP_USE_WDT 1 //if enabled, adds between 33us and 200us per event (1)
#endif

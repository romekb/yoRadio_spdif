...
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT, 19, 1, WA_LEFT }, 140, true, DSP_WIDTH, 5000, 2, 35 };
const ScrollConfig title2Conf     PROGMEM = {{ TFT_FRAMEWDT, 28, 1, WA_LEFT }, 140, true, DSP_WIDTH-26, 5000, 2, 35 };
...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 64-11, 1, WA_LEFT }, 140, true, DSP_WIDTH-6*4, 0, 2, 30 };
...
const FillConfig   volbarConf     PROGMEM = {{ 0, 64-3, 0, WA_LEFT }, DSP_WIDTH, 3, true };
...
const WidgetConfig  clockConf     PROGMEM = { 3, 37, 0, WA_CENTER };

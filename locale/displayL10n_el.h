...
#ifdef WEATHER_FMT_SHORT  // Módisítás
const char weatherFmt[] PROGMEM = "%.1f\011C  \007  %d hPa  \007  %d%% RH";
#else
#if EXT_WEATHER
  #ifdef WEATHER_WIND_UNITS_KPH
    const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 αίσθηση θερμοκρασίας: %.1f\011C \007 πίεση: %d hPa \007 υγρασία: %d%% \007 άνεμος: %.0f kph [%s]";
  #else

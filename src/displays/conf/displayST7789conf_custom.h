...
const FillConfig   volbarConf     PROGMEM = {{ TFT_FRAMEWDT, 240-TFT_FRAMEWDT-4, 0, WA_LEFT }, MAX_WIDTH, 7, true };
...
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 197, 1, WA_CENTER };
...
const VUBandsConfig bandsConf     PROGMEM = { 270, 6, 2, 2, 30, 6 };
...
const MoveConfig   weatherMove    PROGMEM = { 8, 93, MAX_WIDTH };
const MoveConfig   weatherMoveVU  PROGMEM = { 8, 93, MAX_WIDTH };
